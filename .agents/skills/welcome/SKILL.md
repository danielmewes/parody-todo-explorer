---
name: welcome
description: "Greet the user when a new project starts. This mind was created from the Todo Explorer template, so the welcome introduces that template and immediately starts the adaptation conversation."
---

# Welcome the user (template: Todo Explorer)
...
- Title: Todo Explorer
- Slug: `todo-explorer`
- Description: A to-do list wearing a gloriously over-extended late-nineties browser, where all seventy-seven buttons really work
...
1. Open with a short CUSTOM welcome that names **Todo Explorer** and gives the
